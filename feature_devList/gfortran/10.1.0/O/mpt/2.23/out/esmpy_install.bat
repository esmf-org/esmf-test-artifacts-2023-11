...
cd /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_10.1.0_mpt_O_feature_devList/esmf
...
python3 -m pip install . 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_10.1.0_mpt_O_feature_devList/esmpy-install.log
make download 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_10.1.0_mpt_O_feature_devList/esmpy-download.log
deactivate
