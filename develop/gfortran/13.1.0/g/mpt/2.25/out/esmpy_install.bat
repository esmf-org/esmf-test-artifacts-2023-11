...
cd /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_13.1.0_mpt_g_develop/esmf
...
python3 -m pip install . 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_13.1.0_mpt_g_develop/esmpy-install.log
make download 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_13.1.0_mpt_g_develop/esmpy-download.log
deactivate
