...
export WORK_ROOT=/glade/scratch/theurich/ESMF-Nightly-Testing/intel_18.0.5_mpiuni_g_develop
export TEMP_ROOT=/glade/scratch/theurich/ESMF-Nightly-Testing/intel_18.0.5_mpiuni_g_develop
cd $TEMP_ROOT/esmf
export ESMF_DIR=`pwd`
set -o pipefail
